...
if not os.path.exists("resources_downloaded.flag"):
    print("Downloading necessary resources...")

    subprocess.run(["python3",download_resources.py])

    #ダウンロードが終了した際に完了ファイルを作成
    with open("resources_downloaded.flag" ,"w") as flag_file:
